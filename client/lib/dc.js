 ...
 * })
        ...
        dc.baseMixin = function (_chart) {
            ...
            /**
             * Set ID of this chart
             */

            _chart.chartId = function(id) {
                _chartId = id;
                return _chart;
            };
     ...
     *      return 1000;
            ...
            _chart.renderXAxis = function (g) {
                ...
                if (axisXG.empty()) {
                    axisXG = g.append('g')
                        .attr('class', 'axis x')
                        .attr('transform', 'translate(' + _chart.margins().right + ',' + _chart._xAxisY() + ')');
                }
                ...
                if (axisXLab.empty() && _chart.xAxisLabel()) {
                    axisXLab = g.append('text')
                        ...
                        .attr('transform', 'translate(' + (_chart.margins().right + _chart.xAxisLength() / 2) + ',' +
     ...
     * });
         ...
         * Binary buttons
         * Yes or no
         * {@link #dc.baseMixin+ordering ordering}
         * which defaults to sorting by key.
         *
         * IN DEVELOPOMENT
         *
         ...
         * @return {dc.pieChart}
         */
        //dc.binaryButton = function (parent, chartGroup) {
        //    //var DEFAULT_MIN_ANGLE_FOR_LABEL = 0.5;
        //
        //    var _sliceCssClass = 'pie-slice';
        //    var _emptyCssClass = 'empty-chart';
        ...
        //            // otherwise we'd be getting NaNs, so override
        //            // note: abuse others for its ignoring the value accessor
        //            pieData = {key: _emptyTitle, value: 1, others: [_emptyTitle]};
        //            _g.classed(_emptyCssClass, true);
        //        }
        //
        //        if (_g) {
     ...
     * });
        ...
        /**
         * JENNA : Added stacked horizotal row chart
         */
        ...
        /**
         * JENNA : Added scroll on the concrete row chart implementation.
         *
         * Examples:
         * - {@link http://dc-js.github.com/dc.js/ Nasdaq 100 Index}
         ...
         * @return {dc.rowChart}
         */
        dc.scrollableRowChart = function (parent, chartGroup) {
